...
class InvitationTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.sample_key = InvitationKey.objects.create_invitation(user=self.sample_user, email='alice@example.com')
        self.expired_key = InvitationKey.objects.create_invitation(user=self.sample_user, email='alice@example.com')
